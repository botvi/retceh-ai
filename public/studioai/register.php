...
<main class="w-full flex-grow px-4 sm:px-6 py-5 flex items-center justify-center">
    ...
    <!-- View: Register Page -->
    <div id="view-register" class="view-section w-full max-w-sm mx-auto">
        <div class="rounded-3xl border border-zinc-200 bg-white p-6 shadow-xl space-y-6 transition-all duration-300 hover:shadow-2xl">
            ...
            <form id="form-register" class="space-y-4">
                <div class="space-y-1.5">
                    ...
                    <input type="email" id="register-email" required placeholder="nama@contoh.com" class="w-full bg-zinc-50 border border-zinc-200 rounded-xl p-3 text-xs focus:outline-none focus:ring-2 focus:ring-wise-green/50 focus:border-wise-green text-zinc-950 font-medium placeholder-zinc-400 transition-all">
                </div>
                <div class="space-y-1.5">
                    ...
                    <input type="password" id="register-password" required placeholder="••••••••" class="w-full bg-zinc-50 border border-zinc-200 rounded-xl p-3 text-xs focus:outline-none focus:ring-2 focus:ring-wise-green/50 focus:border-wise-green text-zinc-950 font-medium placeholder-zinc-400 transition-all">
                </div>
                <div class="space-y-1.5">
                    ...
                    <input type="tel" id="register-whatsapp" placeholder="Contoh: 081234567890" class="w-full bg-zinc-50 border border-zinc-200 rounded-xl p-3 text-xs focus:outline-none focus:ring-2 focus:ring-wise-green/50 focus:border-wise-green text-zinc-950 font-medium placeholder-zinc-400 transition-all">
                </div>
            ...
            <div class="text-center pt-2">
                <a href="login.php" class="text-xs text-zinc-500 hover:text-zinc-900 transition underline font-semibold">Sudah memiliki akun? Masuk</a>
            </div>
        </div>
    </div>
