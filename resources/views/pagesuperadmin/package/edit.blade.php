                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Edit Paket Top Up</li>
                        </ul>
                    </div>
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h2 class="mb-0">Edit Paket Top Up #{{ $package->id }}</h2>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <form action="{{ route('package.update', $package->id) }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="number" name="credits" class="form-control" value="{{ old('credits', $package->credits) }}" required>
                                </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="is_recommended" id="is_recommended" value="1" {{ $package->is_recommended ? 'checked' : '' }}>
