    ...
    <div id="view-topup" class="view-section w-full max-w-5xl mx-auto space-y-8">
        ...
        <div class="text-center max-w-xl mx-auto space-y-3">
            ...
            <p class="text-xs sm:text-sm text-zinc-500 font-medium leading-relaxed">
                Isi ulang Neurium untuk memproses foto iklan produk komersial secara instan. Setiap render
                memotong 8 Neurium.
            </p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="rounded-2xl border border-zinc-200/80 bg-white p-4.5 text-left space-y-1.5 shadow-xs">
                    <h4 class="text-xs font-black text-forest uppercase tracking-wider flex items-center gap-2">
                        <i class="bi bi-question-circle-fill text-wise-green"></i> Apa itu sistem Neurium?
                    </h4>
                    <p class="text-[11px] text-zinc-500 leading-relaxed font-medium">
                        Neurium adalah saldo render di retcehstudio. Setiap kali Anda menggunakan AI untuk membuat
                        foto produk baru, sistem memotong 8 Neurium.
                    </p>
                </div>
                <!-- FAQ Item 2 -->
                <div class="rounded-2xl border border-zinc-200/80 bg-white p-4.5 text-left space-y-1.5 shadow-xs">
                    ...
                    <p class="text-[11px] text-zinc-500 leading-relaxed font-medium">
                        Tidak. Saldo Neurium yang Anda beli tidak memiliki masa kedaluwarsa dan akan tetap tersimpan
