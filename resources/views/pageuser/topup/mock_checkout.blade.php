...
@section('title', 'Checkout Pembayaran | retcehstudio')
        ...
        <div id="view-checkout" class="view-section w-full max-w-sm mx-auto">
            <div
                ...
                <div class="text-center space-y-1.5">
                    ...
                    <p class="text-xs text-zinc-550 leading-relaxed">Selesaikan pembelian saldo retcehstudio Anda.</p>
                </div>
                ...
                <div class="bg-zinc-50 border border-zinc-200/80 rounded-2xl p-4 space-y-3">
                    ...
                    <div class="flex items-center justify-between pt-1">
                        ...
                        <span class="text-sm font-black text-forest">Rp
                ...
                <form action="{{ route('topup.process', $package->id) }}" method="POST" class="space-y-4">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <select name="payment_method" id="payment-method"
                            class="w-full bg-zinc-50 border border-zinc-200 rounded-xl p-3 text-xs focus:outline-none focus:ring-2 focus:ring-wise-green/50 focus:border-wise-green text-zinc-950 font-medium transition-all">
                ...
                <div class="text-center pt-2">
                    <a href="{{ route('topup.index') }}"
                        class="text-xs text-zinc-500 hover:text-zinc-900 transition underline font-semibold">Batal
                        Pembelian</a>
                </div>
            </div>
        </div>
