    ...
    <div id="view-complete-google-register" class="w-full max-w-sm">
        <div
            ...
            <div class="text-center space-y-1.5">
                <div
                    class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-wise-green/10 text-forest text-[11px] font-bold shadow-sm border border-wise-green/20 text-emerald-600">
                ...
                <p class="text-xs text-zinc-550 leading-relaxed">Hubungkan akun Google Anda dengan melengkapi data
                    berikut.</p>
            </div>
            ...
            <form action="{{ route('google.complete.register') }}" method="POST" class="space-y-4">
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="username" id="username" required placeholder="Buat username unik"
                        value="{{ old('username') }}" class="w-full">
                </div>
                <div class="space-y-1.5">
                    <label for="no_wa"
                        class="text-[11px] font-bold text-forest uppercase tracking-wider block flex items-center gap-1.5">
