        ...
        <div
            ...
            <form action="{{ route('login') }}" method="POST" class="space-y-4">
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="username" id="login-email" required
                        placeholder="username atau nama@contoh.com" value="{{ old('username') }}" class="w-full">
                </div>
                <div class="space-y-1.5">
                    <div class="flex justify-between items-center">
                        <label for="login-password"
                            class="text-[11px] font-bold text-forest uppercase tracking-wider block flex items-center gap-1.5 mb-0">
                            <i class="bi bi-key text-xs text-zinc-400"></i> Kata Sandi
                        </label>
                        <a href="{{ route('forgot-password') }}"
                            class="text-[10px] text-zinc-400 hover:text-zinc-950 transition underline font-bold uppercase tracking-wider">Lupa
                            Sandi?</a>
                    </div>
                    <div class="relative">
            ...
            <div class="text-center pt-2">
                <a href="{{ route('register') }}"
                    class="text-xs text-zinc-500 hover:text-zinc-900 transition underline font-semibold">Belum punya
                    akun? Daftar</a>
            </div>
        </div>
    </div>
