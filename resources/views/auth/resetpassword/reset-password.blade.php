...
<head>
    ...
    <title>Kata Sandi Baru - retcehstudio</title>
    ...
    <div id="view-reset-password" class="w-full max-w-sm">
        <div
            ...
            <div class="text-center space-y-1.5">
                ...
                <p class="text-xs text-zinc-550 leading-relaxed">OTP berhasil diverifikasi! Silakan buat kata sandi baru
                    untuk akun Anda.</p>
            </div>
                ...
                <div class="space-y-1.5">
                    ...
                    <div class="relative">
                        <input type="password" name="password_confirmation" id="password_confirmation" required
                            placeholder="Ulangi kata sandi baru" class="w-full pr-10">
                        <button type="button"
                            class="absolute right-3.5 top-1/2 -translate-y-1/2 text-zinc-400 hover:text-zinc-900 cursor-pointer border-none bg-transparent"
