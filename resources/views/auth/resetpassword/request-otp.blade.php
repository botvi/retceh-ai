...
<head>
    ...
    <title>Lupa Kata Sandi - retcheStudio</title>
    ...
    <div id="view-request-otp" class="w-full max-w-sm">
        <div class="rounded-3xl border border-zinc-200 bg-white p-6 shadow-xl space-y-6 transition-all duration-300 hover:shadow-2xl">
            <div class="text-center space-y-1.5">
                ...
                <p class="text-xs text-zinc-550 leading-relaxed">Masukkan nomor WhatsApp yang terdaftar untuk menerima kode OTP reset password.</p>
            </div>
            ...
            <form action="{{ route('forgot-password.request-otp') }}" method="POST" class="space-y-4">
                ...
                <div class="space-y-1.5">
                    ...
                    <span class="text-[10px] text-zinc-400 font-semibold leading-normal block">OTP akan dikirimkan secara instan ke nomor WhatsApp ini.</span>
                </div>
            ...
            <div class="text-center pt-2 border-t border-zinc-100">
                <a href="{{ route('login') }}" class="text-xs text-zinc-500 hover:text-zinc-900 transition underline font-semibold">Kembali ke halaman login</a>
            </div>
        </div>
    </div>
